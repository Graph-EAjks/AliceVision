...
// Copyright (c) 20 AliceVision contributors.
...
aliceVision::matchingImageCollection::PairGeometricInfo tag_invoke(boost::json::value_to_tag<aliceVision::matchingImageCollection::PairGeometricInfo>, boost::json::value const& jv)
{
